...
public class SongDto implements Validator{
    private int id;
    @NotEmpty(message = "Bạn chưa nhập tên bài hát")
    @Pattern(regexp = "^[A-Za-z0-9\\s]{1,800}$", message = "Tên bài hát không chưa ký tự đặc biệt và có ít hơn 800 ký tự!")
    private String name;
    @NotEmpty(message = "Bạn chưa nhập tên người thể hiện")
    @Pattern(regexp = "^[A-Za-z0-9\\s]{1,300}$", message = "Tên người thể hiện không chưa ký tự đặc biệt và có ít hơn 300 ký tự!")
    private String singer;
    @NotEmpty(message = "Bạn chưa nhập thể loại bài hát")
